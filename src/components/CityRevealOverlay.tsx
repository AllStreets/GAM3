    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1.5 px-4 py-3">
          {/* CAPTURE POSTCARD — placeholder for Task 6 */}
          <button
            disabled
            className="w-full cursor-not-allowed rounded border border-white/10 py-1.5 text-[10px] tracking-[0.25em] opacity-30 uppercase"
          >
            CAPTURE POSTCARD
          </button>
