...
// Widen EONET categories to include volcanoes, floods, severeStorms, wildfires
const EONET_URL = 'https://eonet.gsfc.nasa.gov/api/v3/events?status=open&limit=60&categories=volcanoes,floods,severeStorms,wildfires'
...
const SWPC_URL = 'https://services.swpc.noaa.gov/products/noaa-planetary-k-index.json'
