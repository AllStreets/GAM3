...
## Where We Are (Plans 1–7B shipped, live at https://hyperion-flax.vercel.app)
...
1. **Plan 8 — City reveal** (NEXT): on focusing a place, deepen the fly-to into a cinematic push-in, then reveal a real web-pulled image (Wikimedia Commons geosearch, keyless) + map. Slots into the 7B **cinematic completion beat** (`CompletionFx`/`CompletionCinematic`) — the image blooms in at the pass.
